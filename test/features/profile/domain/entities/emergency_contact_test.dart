...
void main() {
  group('EmergencyContact Entity Tests', () {
    test(
      'should parse name and phone correctly when both are present in the input string',
      () {
    ...
    test(
      'should return empty phoneNumber and fail validation when no phone matches in the input string',
      () {
    ...
    test(
      'should be invalid when phone number format does not match Brazilian standards',
      () {
